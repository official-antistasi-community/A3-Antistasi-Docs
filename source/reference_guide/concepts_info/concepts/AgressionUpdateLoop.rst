...
.. card::
   ...
   .. rst-class:: code-paragraph
      ...
      - :code:`A3A_invaderAttackMul` and :code:`A3A_invaderDefenceMul` are temporary multipliers applied to invader resource gain rates. These aren't currently parameterized.
