...
.. card::
   ...
   | :ref:`Beginners Guide <beginners_guide>` – for information about how to play the mission, in-game systems and how to use them
   | :ref:`Detailed Reference Guide <reference_guide>` – for a look behind the curtain of calculations and more in-depth information
   | :ref:`Dev Guide <dev_guide>` – for general dev information, debug commands, porting instructions and such

   We hope that you find the information you are looking for.
   For further questions, join our `Discord <https://discord.gg/TYDwCRKnKX>`_ or visit us on `Github <https://github.com/official-antistasi-community/A3-Antistasi>`_.

   Good luck and best wishes,
   The Antistasi Dev Team
